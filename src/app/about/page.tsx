...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-2xl px-6 py-20">
      ...
      <h1 className="mb-12 font-mono text-4xl font-bold tracking-tight text-zinc-50">
        Why Invariant Exists
      </h1>

      <div className="space-y-6 text-base leading-relaxed text-zinc-400">
        <p>
          In mathematics, an <em className="text-zinc-300">invariant</em> is a
          property that holds true regardless of the transformations applied to a
          system. A loop invariant holds before and after every iteration. A
          class invariant holds before and after every method call. The concept
          is load-bearing: it is how you reason about correctness when
        ...
        <p>
          ...
          solution hits a stack limit is the same in 2026 as it was in 1986.
        </p>
